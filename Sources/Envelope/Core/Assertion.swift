...
public extension Envelope {
    ...
    ///
    /// - Parameters:
    ///   - assertion: The assertion envelope to be added. May be obscured (encrypted, elided, or compressed), but adding an obscured envelope that is not an assertion is an encoding error, and will be flagged when the envelope is unobscured. If `assertion` is `nil`, no assertion is addded.
