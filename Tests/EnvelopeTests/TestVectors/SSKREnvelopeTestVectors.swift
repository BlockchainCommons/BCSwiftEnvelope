...
final class SSKREnvelopeTestVectors: XCTestCase {
    func testGenerateSSKREnvelopeTestVectors() throws {
        ...
        let text = formatDocument(chapterNumber: sskrEnvelopeTestVectorChapterNumber, testCases: testCases)
        writeDocFile(tocFilename(at: sskrEnvelopeTestVectorChapterNumber), text)
    }
