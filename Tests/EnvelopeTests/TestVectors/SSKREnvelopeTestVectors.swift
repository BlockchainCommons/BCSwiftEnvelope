...
final class SSKREnvelopeTestVectors: XCTestCase {
    func testGenerateSSKREnvelopeTestVectors() throws {
        let testCase1 = try TestCase(
            ...
            expectedFirstShare: "ur:"
        )
        ...
        let testCase2 = try TestCase(
            ...
            expectedFirstShare: "ur:"
        )
        ...
        let testCase3 = try TestCase(
            ...
            expectedFirstShare: "ur:"
        )
    ...
    @StringBuilder
    private func formatDocument(testCases: [AnyTestCase]) -> String {
        documentHeader("SSKR Test Vectors")

        header2("Overview")

        paragraph("This document provides test vectors for scenarios where ``Envelope`` is used with SSKR to shard and recover secrets of any size. It is generated by `SSKREnvelopeTestVectors.testGenerateSSKREnvelopeTestVectors()` in the `BCSwiftEnvelope` test suite.")

        header2("Status")

        paragraph("This document is a draft with a reference implementation in this package.")
