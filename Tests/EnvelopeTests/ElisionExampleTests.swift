...
class ElisionExampleTests: XCTestCase {
    func testRedactionExample2() throws {
        let credential = try Envelope(CID(‡"4676635a6e6068c2ef3ffd8ff726dd401fd341036e920f136a1d8af5e829496d")!)
            ...
            .checkEncoding()
        XCTAssertEqual(credential.ur†, "ur:")
