...
struct ScenarioTests {
    ...
    @Test func testComplexMetadata() throws {
        ...
        """
        #expect(bookMetadata.format() == expectedFormat)
    }
...
//        print(aliceSignedDocument.format())
        #expect(aliceSignedDocument.format() == expectedFormat)
        ...
        #expect(!aliceSignedDocument.isEquivalent(to: aliceSignedDocument2))
        ...
        """
        #expect(aliceRegistration.format() == expectedRegistrationFormat)
        ...
        #expect(aliceURI† == "https://exampleledger.com/arid/d44c5e0afd353f47b02f58a5a3a29d9a2efa6298692f896cd2923268599a0d0f")
        ...
        """
        #expect(aliceChallenge.format() == aliceChallengeExpectedFormat)
        ...
        """
        #expect(aliceChallengeResponse.format() == aliceChallengeResponseExpectedFormat)
        ...
        let responseNonce = try aliceChallengeResponse
            .unwrap()
            .unwrap()
        #expect(aliceChallenge.isEquivalent(to: responseNonce))

        // Bob then extracts Alice's registered URI
        let responseURI = try aliceChallengeResponse
            .unwrap()
            .extractObject(URL.self, forPredicate: .dereferenceVia)
        #expect(responseURI.absoluteString == "https://exampleledger.com/arid/d44c5e0afd353f47b02f58a5a3a29d9a2efa6298692f896cd2923268599a0d0f")
    ...
    @Test func testCredential() throws {
        ...
        """
        #expect(johnSmithResidentCard.format() == expectedFormat)
        ...
        #expect(elidedCredential.urString == "ur:")
        ...
        """
        #expect(elidedCredential.format() == expectedElidedFormat)
        

        
        #expect(elidedCredential.taggedCBOR.cborData.hex == "")
        
        #expect(elidedCredential.diagnostic() == """
        200(   / envelope /
           [
              200(   / envelope /
                 [
              ...
              ),
              {
                 ...
                 [
                    201(   / leaf /
                       40020(   / signature /
                          h'3b19442c4855323828995c77e42a56afb0867e7ad682d60a0c5821fcd64276041ae6de5576453b210a6c2a08fc61eccad6ebae19654fecedc0b1f134d35c0c23'
                       )
                    ),
                    {
                       4:
        ...
        #expect(elidedCredential.treeFormat() == """
        091120c7 NODE
        ...
        """
        #expect(encryptedCredential.format() == expectedEncryptedFormat)
    }

    /// See [The Art of Immutable Architecture, by Michael L. Perry](https://amzn.to/3Kszr1p).
    @Test func testHistoricalModeling() throws {
        //
        // Declare Actors
        //
...
//        let acmeCorpPublicKeys = acmeCorpPrivateKeys.publicKeys
        ...
        """
        #expect(line2.format() == line2ExpectedFormat)
...
//            .revoke(line1.digest)
        ...
        """
        #expect(purchaseOrderProjection.format() == purchaseOrderProjectionExpectedFormat)
    }
    
    @Test func testExampleCredential() {
        let omarCID = ARID()
